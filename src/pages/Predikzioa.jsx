...
export default function Predikzioa() {
  ...
  const [ligaSeleccionada, setLigaSeleccionada] = useState(Object.keys(ligas)[0] || "");
  const [equipoSeleccionado, setEquipoSeleccionado] = useState(null);

  const equipos = ligas[ligaSeleccionada]?.equipos || {};
  const jugadores = equipoSeleccionado && equipos[equipoSeleccionado]
    ? equipos[equipoSeleccionado].jugadores
    : [];
    ...
    <div className="container-fluid">
      <div className="row">
        ...
        <div className="col-md-8 d-flex flex-column align-items-center">
          ...
          <div className="d-flex justify-content-center my-3 flex-wrap">
            {Object.keys(formaciones).map(f => (
              <button
                key={f}
                className={`btn mx-1 my-1 ${alineacion === f ? "btn-primary" : "btn-outline-primary"}`}
          ...
          <div
            ...
            style={{
              width: "100%",
              maxWidth: "600px",
              height: "90vh", // máximo 70% del alto de la pantalla
              overflow: "hidden"
            }}
          >
            <img
              ...
              style={{
                width: "100%",
                height: "100%",
                objectFit: "contain" // mantiene proporción y entra completa
              }}
            />
        ...
        <div className="col-md-2">
          ...
          <div>
            <h6>Elige equipo</h6>
            {Object.entries(equipos).length > 0 ? (
              ...
              <p className="text-muted">No hay equipos en esta liga.</p>
            )}
          </div>
        </div>
